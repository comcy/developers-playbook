...
filename = "projects.component"
source_lang = "en"
target_lang= "en"

obj = XLIFF.XLIFF(filename +".ts", source_lang, target_lang, False) 
...
list_source=["overview", "name", "type"]
list_target=["overview", "name", "type"]
...
xliff = obj.get_str()
with open(filename+".xlf", "w", encoding="utf8") as f:
    f.write(xliff)